...
train on non-IID dataset and quant
```
## 32 bit resnet dorefa
sh run_fedavg_distributed_pytorch.sh 10 10 resnet18_dorefa hetero 500 20 64 0.001 cifar10 "./../../../data/cifar10" adam 32 0


## 8 bit resnet dorefa
sh run_fedavg_distributed_pytorch.sh 10 10 resnet18_dorefa hetero 500 20 64 0.001 cifar10 "./../../../data/cifar10" adam 8 0
...
```
## 32 bit resnet dorefa
sh run_fedavg_distributed_pytorch.sh 10 10 resnet18_dorefa hetero 500 20 64 0.001 fed_cifar100 "./../../../data/fed_cifar100/datasets" adam 32 0


## 8 bit resnet dorefa
sh run_fedavg_distributed_pytorch.sh 10 10 resnet18_dorefa hetero 500 20 64 0.001 fed_cifar100 "./../../../data/fed_cifar100/datasets" adam 8 0
