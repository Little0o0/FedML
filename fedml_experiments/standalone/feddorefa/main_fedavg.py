...
from fedml_api.model.cv.cnn import CNN_DropOut, CNN_Quant
...
def create_model(args, model_name, output_dim):
    ...
    elif model_name == "cnn_quant" and args.dataset == "femnist":
        logging.info("CNN_QUANT + FederatedEMNIST")
        model = CNN_Quant(2, 4, False)
...
if __name__ == "__main__":
    ...
    wandb.init(
        project="fedml",
        name="FedAVG-r" + str(args.comm_round) + "-e" + str(args.epochs) + "-lr" + str(args.lr) + "-model" + str(args.model),
        config=args
    )
