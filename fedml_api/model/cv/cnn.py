...
class CNN_ultra(torch.nn.Module):
    def __init__(self, output_dim):
        ...
        self.conv2d_2 = torch.nn.Conv2d(8, 8, kernel_size=3)
        self.max_pooling_2 = nn.MaxPool2d(2, stride=2)
        self.conv2d_3 = torch.nn.Conv2d(8, 8, kernel_size=3)
...
class CNN(torch.nn.Module):
    def __init__(self, output_dim):
        ...
        self.max_pooling_2 = nn.MaxPool2d(2, stride=2)
        self.conv2d_3 = torch.nn.Conv2d(64, 32, kernel_size=3)
        self.fc1 = nn.Linear(32 * 4 * 4, 128)
        self.fc2 = nn.Linear(128, output_dim)
        self.relu = nn.ReLU()
        self.flatten = nn.Flatten()
