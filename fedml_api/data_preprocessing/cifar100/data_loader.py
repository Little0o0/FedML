...
def get_sub_train_dataloader_CIFAR100(datadir, train_bs, dataidxs=None):
...
def get_sub_test_dataloader_CIFAR100(datadir, test_bs, dataidxs=None):
    dl_obj = CIFAR100_truncated
    transform_train, transform_test = _data_transforms_cifar100()
...
def load_partition_data_cifar100_v2(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size, silo_proc_num=0, n_shots=1, ratio=0.1):
    ...
    test_data_global = get_sub_test_dataloader_CIFAR100(data_dir, batch_size,)
    ...
    val_data_global = get_sub_test_dataloader_CIFAR100(data_dir, batch_size, dataidxs=sample_indices)
    ...
    for client_idx in range(client_number):
        ...
        val_data_local_dict[client_idx] = get_sub_train_dataloader_CIFAR100(data_dir, batch_size, sub_indices)
