...
def load_partition_data_svhn_v2(dataset, data_dir, partition_method, partition_alpha, client_number, batch_size,  n_shots=1, ratio=0.1):
    X_train, y_train, X_test, y_test, net_dataidx_map, traindata_cls_counts = partition_data(dataset,
                                                                                             data_dir,
                                                                                             partition_method,
                                                                                             client_number,
    ...
    test_data_global = get_sub_test_dataloader_svhn(data_dir, batch_size,)
    ...
    val_data_global = get_sub_test_dataloader_svhn(data_dir, batch_size, dataidxs=sample_indices)
    ...
    for client_idx in range(client_number):
        ...
        val_data_local_dict[client_idx] = get_sub_train_dataloader_svhn(data_dir, batch_size, sub_indices)
