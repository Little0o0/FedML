...
from .utils import transform_tensor_to_list, post_complete_message_to_sweep_process, quantization, transform_list_to_tensor
...
class FedAVGServerManager(ServerManager):
    ...
    def handle_message_receive_model_from_client(self, msg_params):
        ...
        bit = msg_params.get(MyMessage.MSG_ARG_KEY_BIT)
        ...
        if b_all_received:
            ...
            global_model_params = quantization(global_model_params, bit)
